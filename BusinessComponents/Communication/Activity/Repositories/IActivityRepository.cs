...
namespace Tunynet.Common.Repositories
{
    ...
    public interface IActivityRepository : IRepository<Activity>
    {
        ...
        bool UpdateLastModified(string tenantTypeId, long sourceId);
        ...
        /// </remarks>
        /// <param name="activityId"></param>
        void DeleteActivityFromUserInboxAndSiteInbox(long activityId, long userId);
        ...
        /// <param name="activityId"></param>
        /// <returns></returns>
        bool isExistInSiteBox(long activityId);
        #endregion
        ...
        ///<returns></returns>
        PagingDataSet<Activity> GetMyTimeline(long userId, long? followGroupId, int? applicationId, MediaType? mediaType, bool? isOriginalThread, int pageIndex, List<string> applicationIds = null);
        ...
        int GetNewerCount(long ownerId, long lastActivityId, int? applicationId, out long userId, int? ownerType, long? exceptUserId);
        ...
        IEnumerable<Activity> GetNewerActivities(long ownerId, long lastActivityId, int? applicationId, int? ownerType, long? exceptUserId);
        ...
        /// <param name="isMobileClient">是否是移动客户端（针对于移动客户端，用来过滤动态）</param> 
        ///<returns></returns>
        PagingDataSet<Activity> GetOwnerActivities(int ownerType, long ownerId, int? applicationId, MediaType? mediaType, bool? isOriginalThread, bool? isPrivate, int pageIndex, long? userId, bool? isMobileClient = null);

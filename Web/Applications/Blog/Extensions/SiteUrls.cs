    ...
    public static class SiteUrlsExtension
    {
        ...
        public static string BlogDetail(this SiteUrls siteUrls, string spaceKey, long threadId, long? commentId = null)
        {
          ...
          //  return CachedUrlHelper.Action("Detail", "Blog", BlogAreaName, dic) + (commentId.HasValue ? "#" + commentId.Value : "");
            return CachedUrlHelper.Action("Detail", "Blog", BlogAreaName, dic);
        }
        ...
        /// <param name="spaceKey"></param>
        /// <returns></returns>
        public static string _BlogCategories(this SiteUrls siteUrls, string spaceKey)
        {
            return CachedUrlHelper.Action("_Categories", "Blog", BlogAreaName, new RouteValueDictionary { { "spaceKey", spaceKey } });
        }
        ...
        {
            return CachedUrlHelper.Action("_Tags", "Blog", BlogAreaName, new RouteValueDictionary { { "spaceKey", spaceKey } });
        }

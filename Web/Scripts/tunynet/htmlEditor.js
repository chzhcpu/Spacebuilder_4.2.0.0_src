...
(function ($) {
    ...
    var simpleOptions = {
        plugins: "paste,fullscreen,media,contextmenu,inlinepopups,changemode,syntaxhl,table,pagebreak",
    ...
    //标准模式
    var standardOptions = {
        plugins: 'paste,fullscreen,media,contextmenu,inlinepopups,syntaxhl,table,pagebreak',
    ...
    $(document).ready(function () {
        ...
        $('textarea[plugin="tinymce"]').livequery(function () {
            ...
            if (data.showPagebreak)
                themeButtons1_add += ",|,pagebreak";
            ...
            $('form:has(textarea[plugin="tinymce"])').find(":submit").click(function () {
                try {
                    tinyMCE.triggerSave();
                } catch (e) {

...
namespace Tunynet.Common
{
    ...
    public class CommentService
    {
        ...
        public PagingDataSet<Comment> GetOwnerComments(long ownerId, string tenantTypeId, DateTime? startDate, DateTime? endDate, int pageIndex, bool? isMobileClient=false)
        {
            //排序：Id倒序
            //缓存分区：OwnerId
            return commentRepository.GetUserComments(ownerId, null, tenantTypeId, startDate, endDate, pageIndex, isMobileClient);
        }
        ...
        public PagingDataSet<Comment> GetUserComments(long userId, string tenantTypeId, DateTime? startDate, DateTime? endDate, int pageIndex)
        {
            //排序：Id倒序
            //缓存分区：UserId
              return commentRepository.GetUserComments(null, userId, tenantTypeId, startDate, endDate, pageIndex, null);
        }
        ...
        public long GetUserCommentCount(long userId, string tenantTypeId)
        {
            //排序：Id倒序
            //缓存分区：UserId
            return commentRepository.GetUserCommentCount(userId, tenantTypeId);
        }
        ...
        public IEnumerable<Comment> GetNewComments(long ownerId, long oldCommentId)
        {
            ...
            return commentRepository.GetNewComments(ownerId, oldCommentId);
        }

...
namespace Spacebuilder.Common
{
    ...
    public class UserSpaceSettingsController : Controller
    {
        ...
        public UserBlockService userBlockService { get; set; }
        public PrivacyService privacyService { get; set; }
        public CategoryService categoryService { get; set; }
        public AccountBindingService accountBindingService { get; set; }
        public ApplicationService applicationService { get; set; }
        public PermissionService permissionService { get; set; }
        public NavigationService navigationService { get; set; }
        private UserProfileSettings userProfileSettings = DIContainer.Resolve<ISettingsManager<UserProfileSettings>>().Get();
        ...
        public ActionResult ManageApplications(string spaceKey)
        {
            ...
            var applications = applicationService.GetInstalledApplicationsOfOwner(PresentAreaKeysOfBuiltIn.UserSpace, currentSpaceUser.UserId);
        ...
        public ActionResult UnInstallApplication(string spaceKey, int applicationId)
        {
            ...
            applicationService.UnInstall(PresentAreaKeysOfBuiltIn.UserSpace, currentSpaceUser.UserId, applicationId);
        ...
        public ActionResult InstallApplication(string spaceKey, int applicationId)
        {
            ...
            if (currentSpaceUser == null)
                return HttpNotFound();
            applicationService.Install(PresentAreaKeysOfBuiltIn.UserSpace, currentSpaceUser.UserId, applicationId);
        ...
        public ActionResult ManagePresentAreaNavigations(string spaceKey)
        {
            ...
            if (currentSpaceUser == null)
                return HttpNotFound();
            var presentAreaNavigations = navigationService.GetRootPresentAreaNavigations(PresentAreaKeysOfBuiltIn.UserSpace, currentSpaceUser.UserId);
            ViewData["currentSpaceUser"] = currentSpaceUser;
        ...
        /// </summary>
        [HttpPost]
        public JsonResult SetPresentAreaNavigationStatus(string spaceKey, int Id, bool isEnabled)
        {
            User user = userService.GetFullUser(spaceKey);
            if (user == null)
        ...
        public ActionResult ManageAccountBindings(string spaceKey)
        {
            ...
            if (!DIContainer.Resolve<Authorizer>().DeleteAccountBinding(user.UserId))
        ...
        {
            long userId = UserIdToUserNameDictionary.GetUserId(spaceKey);
            if (!DIContainer.Resolve<Authorizer>().DeleteAccountBinding(userId))
        ...
        public ActionResult _AccountBinding(string spaceKey, string accountTypeKey)
        {
            ...
            if (user == null || !DIContainer.Resolve<Authorizer>().DeleteAccountBinding(user.UserId))
                return Redirect(SiteUrls.Instance().SystemMessage(TempData, SystemMessageViewModel.NoCompetence()));

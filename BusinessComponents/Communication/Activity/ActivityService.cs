...
namespace Tunynet.Common
{
    ...
    public class ActivityService
    {
        ...
        private ISettingsManager<ActivitySettings> activitySettingsManager = DIContainer.Resolve<ISettingsManager<ActivitySettings>>();
        ...
        {
            return activityRepository.isExistInSiteBox(activityId);
        }
        ...
        {
            return activityRepository.UpdateLastModified(tenantTypeId, sourceId);
        }
        ...
        {
            return activityRepository.GetMyTimeline(userId, followGroupId, applicationId, mediaType, isOriginalThread, pageIndex, applicationIds);
        }
        ...
        public int GetNewerCount(long ownerId, long lastActivityId, int? applicationId, out string operatorName, int? ownerType = null, long? exceptUserId = null)
        {
            ...
            long userId = 0;
            int newerCount = activityRepository.GetNewerCount(ownerId, lastActivityId, applicationId, out userId, ownerType, exceptUserId);
        ...
        public IEnumerable<Activity> GetNewerActivities(long ownerId, long lastActivityId, int? applicationId, int? ownerType = null, long? exceptUserId = null)
        {
            ...
            return activityRepository.GetNewerActivities(ownerId, lastActivityId, applicationId, ownerType, exceptUserId);
        }
        ...
        /// <param name="userId">用户Id</param>
        ///<returns></returns>
        public PagingDataSet<Activity> GetOwnerActivities(int ownerType, long ownerId, int? applicationId, MediaType? mediaType, bool? isOriginalThread, bool? isPrivate, int pageIndex, long? userId = null, bool? isMobileClient = false)
        {
            //按tn_Activities的LastModified倒排序，仅获取IsPrivate=false的动态
            return activityRepository.GetOwnerActivities(ownerType, ownerId, applicationId, mediaType, isOriginalThread, isPrivate, pageIndex, userId, isMobileClient);
        }

//<TunynetCopyright>
//--------------------------------------------------------------
//<copyright>拓宇网络科技有限公司 2005-2011</copyright>
//<version>V0.5</verion>
//<createdate>2012-8-11</createdate>
//<author>yangmj</author>
//<email>yangmj@tunynet.com</email>
//<log date="2012-8-11" version="0.5">创建</log>
//--------------------------------------------------------------
//</TunynetCopyright>
...
namespace Spacebuilder.Common
{
    ...
    public static class SiteUrlsExtensions
    {
        ...
        /// 微博话题详细页中的微博列表
        /// </summary>
        public static string _TopicMicroblogs(this SiteUrls siteUrls, long tagId, int pageSize = 20, int pageIndex = 1)
        {
            return CachedUrlHelper.Action("_TopicMicroblogs", "ChannelMicroblog", MicroblogAreaName, new RouteValueDictionary { { "tagId", tagId }, { "pageSize", pageSize }, { "pageIndex", pageIndex } });
        }

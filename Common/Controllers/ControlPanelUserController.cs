...
namespace Spacebuilder.Common
{
    ...
    public class ControlPanelUserController : Controller
    {
        ...
        public IMembershipService iMembershipService { get; set; }
        public RoleService roleService { get; set; }
        public UserRankService userRankService { get; set; }
        public IdentificationService identificationService { get; set; }
        public PointService pointService { get; set; }
        public SystemDataService systemDataService { get; set; }
        ...
        {
            IEnumerable<ApplicationBase> apps = applicationService.GetAll();

...
namespace Tunynet.Common
{
    ...
    public class VisitService
    {
        ...
        /// <param name="toObjectId"></param>
        /// <returns></returns>
        public void DeleteCachekey(long toObjectId)
        {
            visitRepository.DeleteCachekey(tenantTypeId, toObjectId);
        }
        ...
        public IEnumerable<long> GetVisitorAlsoVisitedObjectIds(long toObjectId, int topNumber)
        {
            return visitRepository.GetVisitorAlsoVisitedObjectIds(tenantTypeId, toObjectId, topNumber);
        }
    }
}
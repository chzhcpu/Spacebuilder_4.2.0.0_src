...
public class Handler : IHttpHandler
{
    ...
    private void StreamGzipContents()
    {
        ...
        cachePath = Tunynet.Utilities.WebUtility.ResolveUrl("~/App_Data/HttpCache"); // Cache path, this is where the .gz files will be stored
		...
		*/};
        ...
        if (diskCache)
        {
            ...
            cacheFile = Tunynet.Utilities.WebUtility.GetPhysicalFilePath(cacheFile);
        }

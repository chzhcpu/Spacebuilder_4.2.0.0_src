...
namespace Tunynet.Common.Repositories
{
    ...
    public interface IVisitRepository : IRepository<Visit>
    {
        ...
        IEnumerable<long> GetVisitorAlsoVisitedObjectIds(string tenantTypeId, long toObjectId, int topNumber);
        ...
        void DeleteCachekey(string tenantTypeId, long toObjectId);
    }
}

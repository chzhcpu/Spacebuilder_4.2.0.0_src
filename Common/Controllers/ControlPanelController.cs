    ...
    public class ControlPanelController : Controller
    {
        ...
        public ActionResult Home()
        {
            ...
            foreach (var application in applications)
            {
                ...
                //获取所有待处理数据实体
                IApplicationStatisticDataGetter dataGetter = DIContainer.ResolveNamed<IApplicationStatisticDataGetter>(application.ApplicationKey);
                
                IEnumerable<ApplicationStatisticData> manageableDatas = dataGetter.GetManageableDatas();
                //获取所有数据统计应用数据实体
                IEnumerable<ApplicationStatisticData> applicationStatisticDatas = dataGetter.GetStatisticDatas();

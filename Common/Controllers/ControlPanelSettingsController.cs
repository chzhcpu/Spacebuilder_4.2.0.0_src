...
namespace Spacebuilder.Common
{
    ...
    public class ControlPanelSettingsController : Controller
    {
        ...
        public ManagementOperationService operationService { get; set; }
        public AreaService areaService { get; set; }
        public SchoolService schoolService { get; set; }
        public ThemeService themeService { get; set; }
        public PresentAreaService presentAreaService { get; set; }
        public EmotionService emotionService { get; set; }
        public SensitiveWordService sensitiveWordService { get; set; }
        ...
        public ISettingsManager<UserSettings> userSettingsManager { get; set; }
        public ISettingsManager<UserProfileSettings> userProfileSettingsManager { get; set; }
        public ISettingsManager<CommentSettings> commentSettingsManager { get; set; }
        public ISettingsManager<InviteFriendSettings> inviteFriendSettingsManager { get; set; }
        public ISettingsManager<AttachmentSettings> attachmentSettingsManager { get; set; }
        public ISettingsManager<EmailSettings> emailSettingsManager { get; set; }
        public ISettingsManager<ReminderSettings> reminderSettingsManager { get; set; }
        public ISettingsManager<PauseSiteSettings> pauseSiteSettingsManager { get; set; }
        public ISettingsManager<PointSettings> pointSettingsManger { get; set; }
        public ISettingsManager<NoticeSettings> noticeSettingsManager { get; set; }
        public ISettingsManager<InvitationSettings> invitationSettingsManager { get; set; }
        ...
        public ActionResult _CreateNavigation(int parentNavigationId, int? applicationId, string presentAreaKey = PresentAreaKeysOfBuiltIn.Channel)
        {
            ...
            return View(new NavigationCreateModel { IsWholeLink = true });
        }
        ...
        public ActionResult _CreateNavigation(NavigationCreateModel navigationCreateModel)
        {
            ...
            PresentArea presentArea = presentAreaService.GetAll().FirstOrDefault(n => n.PresentAreaKey.Equals(presentAreaKey, StringComparison.CurrentCultureIgnoreCase));
            if (presentArea == null)
            {
                return Json(new StatusMessageData(StatusMessageType.Error, "找不到呈现区域"));
            }
            InitialNavigation initialNavigation = navigationCreateModel.AsInitialNavigation();
            initialNavigation.PresentAreaKey = presentArea.PresentAreaKey;
        ...
        public ActionResult SetApplicationStatus(int applicationId)
        {
            ...
            applicationService.SetStatus(applicationId, isEnabled);
            return Json(new StatusMessageData(StatusMessageType.Success, "设置成功！"));
        }
        #endregion 后台应用管理

    ...
    public class TenantCommentSettings
    {
        ...
        private TenantCommentSettings(XElement xElement)
        {
            if (xElement != null)
            {
                ...
                att = xElement.Attribute("enableRecommend");
                if (att != null)
                {
                    bool temp = false;
                    if (bool.TryParse(att.Value, out temp))
                        _enableRecommend = temp;
                }

                att = xElement.Attribute("recommendItemTypeId");
                if (att != null)
                    _recommendItemTypeId = att.Value;
            }
        }
        ...
        private bool _enableRecommend = false;
        /// <summary>
        /// 是否启用推荐
        /// </summary>
        public bool EnableRecommend
        {
            get { return _enableRecommend; }
        }

        private string _recommendItemTypeId = string.Empty;
        /// <summary>
        /// 推荐类型Id
        /// </summary>
        public string RecommendItemTypeId
        {
            get { return _recommendItemTypeId; }
        }

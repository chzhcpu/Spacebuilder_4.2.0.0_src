...
namespace Spacebuilder.Common
{
    ...
    public class ExceptionHandlerAttribute : FilterAttribute, IExceptionFilter
    {
        ...
        public virtual void OnException(ExceptionContext filterContext)
        {
            ...
            filterContext.Result = new RedirectResult(SiteUrls.Instance().SystemMessage(filterContext.Controller.TempData, new SystemMessageViewModel { StatusMessageType = StatusMessageType.Error, Title = "出错了", Body = exceptionFacade.Message }));

...
namespace Tunynet.Common
{
    ...
    public class NoticeService
    {
        ...
        public ISettingsManager<NoticeSettings> noticeSettingsManager = DIContainer.Resolve<ISettingsManager<NoticeSettings>>();
        ...
        public IEnumerable<Notice> GetTops(long userId, int topNumber)
        {
            ...
            //var item = noticeRepository.GetTops(userId, topNumber);

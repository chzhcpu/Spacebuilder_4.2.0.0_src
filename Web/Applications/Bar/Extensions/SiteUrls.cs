...
namespace Spacebuilder.Bar
{
    ...
    public static class SiteUrlsExtension
    {
        ...
        /// <param name="childPostIndex">自己回复的列表页码</param>
        /// <returns>帖子的详细显示链接</returns>
        public static string TopicThreadDetail(this SiteUrls urls, string spaceKey, long threadId, bool onlyLandlord = false, SortBy_BarPost sortBy = SortBy_BarPost.DateCreated, int? pageIndex = 1, long? anchorPostId = null, bool isAnchorPostList = false, long? childPostIndex = null)
        {
            RouteValueDictionary routeValueDictionary = new RouteValueDictionary();
            routeValueDictionary.Add("spaceKey", spaceKey);
            ...
            if (anchorPostId.HasValue && anchorPostId.Value > 0)
                ...
                anchor = "#reply";
            return CachedUrlHelper.RouteUrl("Topic_Bar_ThreadDetail", routeValueDictionary) + anchor;
        }
        ...
        /// </summary>
        /// <param name="urls"></param>
        /// <param name="spaceKey">群组topicKey</param>
        /// <param name="categoryId">分类id</param>
        /// <param name="isEssential">是否精华</param>
        /// <param name="sortBy">排序方式</param>
        /// <param name="pageIndex">回帖页码</param>
        /// <returns>群组贴吧首页</returns>
        public static string TopicSectionDetail(this SiteUrls urls, string spaceKey, long? categoryId = null, bool? isEssential = null, SortBy_BarThread? sortBy = null, int pageIndex = 1, bool? isPosted = null)
        {
            RouteValueDictionary dic = new RouteValueDictionary();
            dic.Add("spaceKey", spaceKey);
            if (categoryId.HasValue)
            ...
            if (isPosted.HasValue)
                dic.Add("isPosted", isPosted);
            return CachedUrlHelper.Action("SectionDetail", "TopicSpaceBar", BarAreaName, dic);
        }
        ...
        /// <param name="pageIndex">页码</param>
        /// <returns>群组贴吧标签下的帖子</returns>
        public static string TopicThreadListByTag(this SiteUrls urls, string spaceKey, string tagName, SortBy_BarThread? sortBy = null, bool? isEssential = null, int pageIndex = 1)
        {
            RouteValueDictionary dic = new RouteValueDictionary();
            dic.Add("spaceKey", spaceKey);
            dic.Add("tagName", tagName);
            ...
            if (pageIndex > 1)
                dic.Add("pageIndex", pageIndex);
            return CachedUrlHelper.Action("ListByTag", "TopicSpaceBar", BarAreaName, dic);
        }
        ...
        /// <param name="threadId">帖子id</param>
        /// <returns>创建/编辑页面</returns>
        public static string TopicThreadEdit(this SiteUrls urls, string spaceKey, long? threadId)
        {
            RouteValueDictionary dic = new RouteValueDictionary();
            dic.Add("spaceKey", spaceKey);
            if (threadId.HasValue)
                dic.Add("threadId", threadId);
            return CachedUrlHelper.Action("Edit", "TopicSpaceBar", BarAreaName, dic);
        }
        ...
        /// <param name="postId">回帖id</param>
        /// <returns>群组中的编辑回帖页面</returns>
        public static string TopicEditPost(this SiteUrls urls, string spaceKey, long threadId, long? postId = null)
        {
            RouteValueDictionary dic = new RouteValueDictionary();
            dic.Add("spaceKey", spaceKey);
            dic.Add("threadId", threadId);
            ...
            if (postId.HasValue)
                dic.Add("postId", postId);
            return CachedUrlHelper.RouteUrl("Topic_Bar_Common", dic);
        }
        ...
        /// <param name="isPosted">是否是回帖</param>
        /// <returns>群组中用户的帖子</returns>
        public static string TopicUserThreads(this SiteUrls urls, string spaceKey, bool isPosted = false)
        {
            RouteValueDictionary dic = new RouteValueDictionary();
            dic.Add("spaceKey", spaceKey);
            if (isPosted)
                dic.Add("isPosted", isPosted);
            return CachedUrlHelper.Action("UserThreads", "TopicSpaceBar", BarAreaName, dic);
        }
        ...
        /// <param name="spaceKey">群组topicKey</param>
        /// <returns>群组管理帖子页面</returns>
        public static string TopicManageThreads(this SiteUrls urls, string spaceKey)
        {
            RouteValueDictionary dic = new RouteValueDictionary();
            dic.Add("spaceKey", spaceKey);
            return CachedUrlHelper.Action("ManageThreads", "TopicSpaceBar", BarAreaName, dic);
        }
        ...
        /// <param name="spaceKey">群组topicKey</param>
        /// <returns>群组管理回帖页面</returns>
        public static string TopicManagePosts(this SiteUrls urls, string spaceKey)
        {
            RouteValueDictionary dic = new RouteValueDictionary();
            dic.Add("spaceKey", spaceKey);
            return CachedUrlHelper.Action("ManagePosts", "TopicSpaceBar", BarAreaName, dic);
        }
        ...
        /// <param name="spaceKey">群组topicKey</param>
        /// <returns>群组管理帖子分类页面</returns>
        public static string TopicManageThreadCategories(this SiteUrls urls, string spaceKey)
        {
            RouteValueDictionary dic = new RouteValueDictionary();
            dic.Add("spaceKey", spaceKey);
            return CachedUrlHelper.Action("ManageThreadCategories", "TopicSpaceBar", BarAreaName, dic);
        }
        ...
        /// <param name="keyWord">关键字</param>
        /// <returns>群组贴吧搜索页面</returns>
        public static string TopicBarThreadSearch(this SiteUrls urls, string spaceKey, string keyWord = null)
        {
            RouteValueDictionary dic = new RouteValueDictionary();
            dic.Add("spaceKey", spaceKey);
            ...
            return CachedUrlHelper.Action("Search", "TopicSpaceBar", BarAreaName, dic);
        }
        ...
        /// <param name="spaceKey"></param>
        /// <returns></returns>
        public static string TopicTags(this SiteUrls siteUrls, string spaceKey)
        {
            return CachedUrlHelper.Action("Tags", "TopicSpaceBar", BarAreaName, new RouteValueDictionary { { "spaceKey", spaceKey } });
        }
        ...
        /// <param name="keyWord"></param>
        /// <returns></returns>
        public static string TopicBarThreadSearch(this SiteUrls urls, long sectionId, string keyWord = null)
        {
            string spaceKey = TopicIdToTopicKeyDictionary.GetTopicKey(sectionId);
            return urls.TopicBarThreadSearch(spaceKey, keyWord);
        }

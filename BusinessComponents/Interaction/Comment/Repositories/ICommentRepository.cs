...
namespace Tunynet.Common.Repositories
{
    ...
    public interface ICommentRepository : IRepository<Comment>
    {
        ...
        /// <returns></returns>
        PagingDataSet<Comment> GetUserComments(long? ownerId, long? userId, string tenantTypeId, DateTime? startDate, DateTime? endDate, int pageIndex, bool? isMobileClient = null);
        ...
        /// <returns></returns>
        IEnumerable<Comment> GetNewComments(long ownerId, long oldCommentId);
        ...
        long GetUserCommentCount(long userId, string tenantTypeId);
    }
}

...
namespace Tunynet.Common
{
    ...
    public interface IRatingRepository : IRepository<Rating>
    {
        ...
        /// <returns></returns>
        int GetRatingCount(long objectId, string tenantTypeId);
        ...
        /// <param name="tenantTypeId">租户Id</param>
        /// <returns></returns>
        int GetRatingCountForVideo(long ownerId, string tenantTypeId);
        ...
        /// <param name="tenantTypeId">租户Id</param>
        /// <returns></returns>
        float GetRatingResult(long objectId, string tenantTypeId);
        ...
        /// <param name="tenantTypeId">租户Id</param>
        /// <returns></returns>
        float GetRatingResultForVideo(long ownerId, string tenantTypeId);

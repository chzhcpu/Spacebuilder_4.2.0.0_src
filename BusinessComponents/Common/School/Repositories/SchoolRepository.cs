...
namespace Tunynet.Common.Repositories
{
    ...
    public class SchoolRepository : Repository<School>, ISchoolRepository
    {
        ...
        public Sql GetSql_Gets(string areaCode, string keyword, SchoolType? schoolType)
        {
            ...
            if (!string.IsNullOrEmpty(areaCode))
            {
                ...
                else
                {
                    ...
                    if (schoolAreaCode.Length % 2 == 1)
                        schoolAreaCode += "0";
                    sql_Select.Where("AreaCode like @0", StringUtility.StripSQLInjection(schoolAreaCode) + "%");
                }
            }
            ...
            if (!string.IsNullOrEmpty(keyword))
                sql_Select.Where("(Name like @0 or PinyinName like @0 or ShortPinyinName like @0)", "%" + StringUtility.StripSQLInjection(keyword) + "%");

        ...
        attr: function (elem, name, value, pass) {
            ...
            if (value !== undefined) {
                ...
                if (value === null) {
                    ...
                    try { elem.setAttribute(name, "" + value); } catch (e) { }
                    return value;
                }
    ...
    if (!getSetAttribute) {
        ...
        nodeHook = jQuery.valHooks.button = {
            ...
            set: function (elem, value, name) {
                ...
                //bianchx，2013-3-25 15:36:57：修复IE7下设置属性报错的问题
                elem.setAttribute(ret, value + "");
                return (ret);
            }
        };
    ...
    jQuery.fn.extend({
        ...
        offsetParent: function () {
            return this.map(function () {
                ...
                //libsh,2013-03-04,修复jquery在ie7/8下会报错的问题
                var offsetParent;
                if (typeof this.offsetParent == "object") {
                    offsetParent = this.offsetParent || document.body;
                }
                else {

...
namespace Tunynet.Common
{
    ...
    public class RatingService
    {
        ...
        /// <returns></returns>
        public int GetRatingCount(long objectId)
        {
           return   ratingRepository.GetRatingCount(objectId,tenantTypeId);
        }
        ...
        /// <returns></returns>
        public float GetRatingResult(long objectId)
        {
            return ratingRepository.GetRatingResult(objectId, tenantTypeId);
        }
        ...
        /// <param name="ownerId">拥有者Id</param>
        /// <returns></returns>
        public float GetRatingResultForVideo(long ownerId)
        {
            return ratingRepository.GetRatingResultForVideo(ownerId, tenantTypeId);
        }
        ...
        /// <param name="userId">用户Id</param>
        /// <returns></returns>
        public RatingRecord GetUserRatingRecords(long objectId, long userId)
        {
            return ratingRecordRepository.GetUserRatingRecords(objectId, tenantTypeId, userId);
        }

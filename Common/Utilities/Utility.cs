...
namespace Spacebuilder.Common
{
    ...
    public class Utility
    {
        ...
        {
            string key = System.Configuration.ConfigurationManager.AppSettings["TokenKeyForQuickLogin"];
            string iv = System.Configuration.ConfigurationManager.AppSettings["TokenIvForQuickLogin"];
            return EncryptToken(timeliness, userId, key, iv);
        }
        /// <summary>
        /// 解密Token

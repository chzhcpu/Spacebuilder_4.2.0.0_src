...
INSERT [dbo].[spb_Profiles] ([UserId],[Integrity],[Birthday],[LunarBirthday],[NowAreaCode],[HomeAreaCode],[Email],[Mobile],[QQ],[Msn],[Skype],[Fetion],[Aliwangwang],[CardType],[CardID],[Introduction]) VALUES (207677921948,0,getdate(),getdate(),N'',N'',N'',N'',N'',N'',N'',N'',N'',0,N'',N'')
...
INSERT [dbo].[tn_SystemData] (Datakey, LongValue, DecimalValue) VALUES ('SPBVersion', 0, 4.2)
